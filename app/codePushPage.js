...
export default class extends Component {
    ...
    render(){
        ...
        if (this.state.syncMessage) {
            syncView = (
                <View style={codePushCSS.TitleWrap}>
                    <Text style={codePushCSS.Title}>{this.state.syncMessage}</Text>
                </View>
            );
        }
        progressView = (
            <View style={codePushCSS.percentWrap}>
                <Text style={codePushCSS.percent}>{this.state.progress && parseInt((this.state.progress.receivedBytes/this.state.progress.totalBytes)*100)}%</Text>
            </View>
        );
        return (
            <View style={codePushCSS.Wrapper}>
                {progressView}
                {syncView}
            </View>
        )
...
const codePushCSS = StyleSheet.create({
    Wrapper: {
